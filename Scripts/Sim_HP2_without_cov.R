...
parSim(
  ...
  name = "Simulations/sim_HP2_without_cov_01", # Name of the file
...
# To load the results -----------------------------------------------------
archivos <- list.files(pattern = "^sim_HP2_without_cov.*\\.txt$", 
                       path="Simulations",
                       full.names = TRUE)
...
figs_case2_mean <- function(res, true_mu, k) {
  ...
  the_mean <- grid.arrange(p1, p2, p3, p4, p5, p6,
                           nrow = 3, ncol=2)
  the_mean
  ggsave(filename=paste0("Figures/case2_mean_true_mu=", true_mu, ".pdf"), 
         plot=the_mean, 
         width=6, height=8)
}

figs_case2_mean(res, true_mu=3, k=0.2)
figs_case2_mean(res, true_mu=7, k=0.2)

# MSE -----------------------------------------------------

figs_case2_mse <- function(res, true_mu) {
  ...
  the_mse <- grid.arrange(p1, p2, p3, p4, p5, p6,
                           nrow = 3, ncol=2)
  the_mse
  ggsave(filename=paste0("Figures/case2_mse_true_mu=", true_mu, ".pdf"), 
         plot=the_mse, 
         width=6, height=8)
}

figs_case2_mse(res, true_mu=3)
figs_case2_mse(res, true_mu=7)
